...
import { View,TextInput,Dimensions,Text, ScrollView} from 'react-native';
    ...
    return (
        <ScrollView>
            <View style={{width:Dimensions.get("screen").width,height:Dimensions.get('screen').height,marginTop:'6%',padding:'4%',backgroundColor:'#fff'}}>
                ...
                <View style={{width:'100%',height:'5%',marginTop:'2%',borderWidth:1,borderRadius:5,borderColor:'#8c8c8c',padding:'2%'}}>
                    <TextInput
