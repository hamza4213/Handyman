...
const ElectricianScreen = ({navigation}) => {
    ...
    <View style={{ flex:1 }}>
        ...
        <View style={{ height: 15, backgroundColor: "#D3D3D3" }}></View>
        <View>
            <Text style={{left:20,fontSize:20,fontWeight:'bold'}}>SERVICE INFORMATION</Text>
        <View style={{flexDirection:'row'}}>
            <Text style={{left:20,fontSize:18,}}>Additional </Text>
            <Text style={{left:20,fontSize:20,fontWeight:'bold',color:'grey'}}>Information </Text>
            </View>
        </View>
        <View style={{width:'95%', alignSelf:'center'}}>
        ...
        <View style={{height:15,backgroundColor:'#D3D3D3'}}></View>
        <View style={{flexDirection:'row'}}>
            <View style={{height:5,width:5,backgroundColor:'black',top:7,borderRadius:5,left:5}}></View>
            <Text style={{left:10,fontSize:16}}>Material charges extra</Text>
        </View>
        <View style={{flexDirection:'row'}}>
            <View style={{height:5,width:5,backgroundColor:'black',top:7,borderRadius:5,left:5}}></View>
            <Text style={{left:10,fontSize:16}}>An inspection charge of RS.100 may be charged if the </Text>
        </View>
        <View>
            <Text style={{left:15,fontSize:16}}>costumer decides not to continue with the service after inspection.</Text>
        </View>
        ...
        />
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('UserSignIn')} style={{backgroundColor:'grey',height:50,width:350,alignSelf:'center',borderRadius:10,position:'absolute',top:"85%"}}>
                <Text style={{textAlign:'center',top:12,fontSize:18,color:'#fff',fontWeight:'bold'}}>CONTINUE BOOKING</Text>
            </TouchableOpacity>
    </View>
    );
}
